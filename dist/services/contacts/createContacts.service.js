...
const createContactService = (data, customerId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const contact = contactRepository.create(Object.assign(Object.assign({}, data), { customer: customer }));
    console.log(contact);
    yield contactRepository.save(contact);
    return contacts_schema_1.contactSchema.parse(contact);
});
