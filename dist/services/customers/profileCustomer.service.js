...
exports.profileCustomerService = void 0;
...
const profileCustomerService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!customer) {
        throw new App_error_1.AppError("Customer not found");
    }
    return customers_schema_1.customerSchemaResponse.parse(customer);
});
exports.profileCustomerService = profileCustomerService;
